...
var tests = [
...

	{
		...
		testArray: [
			...
			{srcset: 'data:,a " , data:,b 1x, ", data:,c',   expect: 'data:,b', desc: 'quotes'},
			{srcset: 'data:,a \\,data:;\\,b, data:,c',         expect:'data:;\\,b', desc: 'backslashes'},
			{srcset: 'data:,a, data:,b (',   expect:'data:,a', desc: 'unclosed paren'},
			...
			{srcset: 'data:,a //, data:,b', expect:'data:,b', desc: 'double slash comments'},
		]
	},
